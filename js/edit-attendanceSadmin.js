// Edit Attendance Sadmin Module
console.log("EDIT ATTENDANCE SADMIN JS LOADED");
...
window.addEventListener("DOMContentLoaded", async () => {
    try {
        ...
        if (!attendanceId) {
            ...
            window.location.href = "attendanceSadmin.html";
            return;
        }
...
async function updateAttendance(e) {
    ...
    try {
        ...
        window.location.href = "view-attendanceSadmin.html?id=" + attendanceId;
    } catch (error) {
